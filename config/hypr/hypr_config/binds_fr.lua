...
local programs = require("hypr_config/programs")

---------------------
---- KEYBINDINGS ----
---------------------

-- THESES BINDS ARE FOR AZERTY KEYBOARDS
-- See https://wiki.hypr.land/Configuring/Basics/Binds/ for more


local mainMod = "SUPER" -- Sets "Windows" key as main modifier

hl.bind(mainMod .. " + SUPER_L", hl.dsp.exec_cmd("pgrep -x rofi && killall rofi || " .. programs.menu))
hl.bind(mainMod .. " + A", hl.dsp.exec_cmd(programs.terminal))
hl.bind(mainMod .. " + code:58", hl.dsp.exec_cmd("command -v hyprshutdown >/dev/null 2>&1 && hyprshutdown || hyprctl dispatch 'hl.dsp.exit()'"))
...
hl.bind("PRINT", hl.dsp.exec_cmd("grim -g \"$(slurp -b#00000090 -w 0)\" - | wl-copy"))
...
for i = 1, 10 do
    ...
    hl.bind(mainMod .. " + SHIFT + code:" .. keycode,     hl.dsp.window.move({ workspace = i, follow=false}))
end
